...
public class ImportResult {
    ...
    public void addSuccess(Song s) { if (s != null) successes.add(s); }
    public void addFailure(File f, String reason) { failures.add(new ImportFailure(f, reason)); }

    public List<Song> getSuccesses() { return Collections.unmodifiableList(successes); }
    public List<ImportFailure> getFailures() { return Collections.unmodifiableList(failures); }
